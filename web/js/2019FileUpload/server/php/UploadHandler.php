...
#            $this->initialize();
    ...
    public function set_upload_path($strApp, $strID) {
		$strDir = $this->options['upload_dir'].$strApp;
		...
		$strNewExt = $strApp."/".$strID;
        $this->options['upload_dir'] = $this->options['upload_dir'].$strNewExt."/";
        $this->options['upload_url'] = $this->options['upload_url'].$strNewExt."/";
		$this->initialize();
	}
